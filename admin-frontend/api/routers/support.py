...
async def get_photo(
    ...
    Downloads from Telegram and returns the image.
    """
    ...
    try:
        ...
        return StreamingResponse(
            ...
            headers={"Content-Disposition": f"inline; filename=photo.jpg"}
        )
        
    except Exception as e:
        logger.error("Failed to get photo", file_id=file_id, error=str(e))
        raise HTTPException(
            status_code=status.HTTP_404_NOT_FOUND,
            detail="Photo not found or expired"
        )
