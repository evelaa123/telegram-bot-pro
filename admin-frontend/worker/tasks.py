        ...
        for reminder, user in reminders:
            try:
                ...
                if reminder.recurrence == "daily":
                    ...
                    # Get user's timezone to preserve the same local time
                    ...
                    # Convert current remind_at to user's timezone, add 1 day, convert back to UTC
                    current_local = reminder.remind_at.astimezone(user_tz)
